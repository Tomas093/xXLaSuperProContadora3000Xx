...
3. Optional catalog visual analysis JSON from a previous step:
   - "catalog_visual_analysis": visual-only notes associated with catalog filenames and component names.
4. Attached symbol images:
...
- If catalog visual analysis is provided, use it only to distinguish visually similar catalog symbols.
...
- Do NOT identify a material by electrical meaning, component name meaning, or expected plan context.
